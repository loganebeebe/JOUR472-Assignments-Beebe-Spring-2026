...
**Task** Run the following code and describe the dataframe it outputs. **Answer Its complaints and ids of files and doctors**
...
**Task** Run the following code and describe the results. Do any of the sentiments seem incorrect or counter-intuitive? **Answer One sentiment that was counter intuitive was the word "right" being marked as positive- because there are plenty of uses of the word right that would be a negative meaning, like right to appeal is more legal and not necessarily positive. And for that matter appeal is also not always positive. Words being positive and negative, for most things, need the context for us to understand if they were good or bad in the actually data.**
