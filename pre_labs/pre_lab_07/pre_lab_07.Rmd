...
**Task** Run the following codeblock to find the Maryland county with the highest median household income and put the answer below. **Answer Montgomery County**
...
**Task** Run the following codeblock to create a chart showing the margin of error for each county. The current headline isn't very descriptive of the data. What should it be? **Answer Median Household Income By Maryland County With Margins of Error (2017–2021)**
...
Is the difference between Calvert and Montgomery significant? **Answer its not super significant**

Is the difference between Howard and everyone else significant? **Answer Howard county doesn't overlap with many others so it is likely significant**
...
**Task** Let's look at the average household income for high schools that have 60% or more graduates immediately enrolling in college, and then look at those with less than 40%. Write a sentence describing the results. **Answer high schools where 60% of graduates enroll in college tend to be located in areas with** **higher average household incomes**- **while schools with 40% or fewer enrollments are more in** **low-income areas**
...
**Task** What is another question you could ask of this data? **Answer Do high schools in high income ZIP codes have smaller or larger graduating class sizes?**
