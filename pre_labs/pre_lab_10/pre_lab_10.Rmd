...
**Task** Run the following code to load data. Describe what you see in the answer space below. What columns exist in this data? **Answer: its 526 zip codes and 7 fields. It includes columns like ZIPCODE1, ZIPNAME, and Shape_Area. The most important column is geometry, which contains MULTIPOLYGON data used to map the boundaries of each zip code.**
...
**Task** Run the following code. Describe the output in the space below: what kind of information does it contain? **Answer The table shows maryland zip codes with geographic boundary data.**
...
**Task** Run the following code. Describe the output in the space below. **Answer It is a map of the state of maryland and it's zipcodes**
...
**Task** Run the following code. Describe the output in the space below. **Answer it says "**To enable caching of data, set \`options(tigris_use_cache = TRUE)\`in your R script or .Rprofile."
...
**Task** Run the following code. Describe the output in the space below. **Answer Its all the US counties with** **a geometry column for mapping.**
...
**Task** Run the following code. Describe the output in the space below. **Answer The dataset now only includes counties in Maryland.**
...
**Task** Run the following code. Describe the output in the space below. **Answer its a map of maryland and the counties.**
...
**Task** Run the following code. Describe the output in the space below. **Answer it shows counties with zip codes layered on top**
...
**Task** Run the following code. Describe the output in the space below. **Answer foreclosure notices by zip code for March 2023.**
...
**Task** Run the following code. Describe the output in the space below. **Answer now its merged together**
...
**Task** Run the following code. Describe the output in the space below. **Answer it shows foreclosure counts by zip code now colored, with lighter areas indicating higher numbers.**
...
**Task** Run the following code. Describe the output in the space below. **Answer foreclosure counts by county and population data for each county.**
...
**Task** Run the following code. Describe the output in the space below. **Answer now it has geometry so it can be mapped.**
...
**Task** Run the following code. Describe the output in the space below. **Answer The two datasets both include county names, but they are formatted differently.**
...
**Task** Run the following code. Describe the output in the space below. **Answer The dataset now has a cleaned county column, along with population and geometry**
...
**Task** Run the following code. Describe the output in the space below. **Answer it now includes county name, population, foreclosure notices, and geometry.**
